"""
Mage Data Loader: Jira Issue Links via DLT (OPTIMIZED)

Target: raw_jira.issue_links
...
@data_loader
def load_jira_issue_links_via_dlt(data, *args, **kwargs):
    """Load Jira issue links via DLT."""
    ...
    result = run_dlt_script(
        script_path='/home/dlt/jira/jira_issue_links_optimized.py',
        target_table='raw_jira.issue_links',
        fail_on_error=True,
