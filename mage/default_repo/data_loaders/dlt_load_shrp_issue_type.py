"""
Mage Data Loader: SharePoint Issue Type via DLT

Target: raw_sharepoint.issue_type
"""
...
@data_loader
def load_sp_issue_type_via_dlt(*args, **kwargs):
    """Load SharePoint Issue Type list via DLT."""
    ...
    result = run_dlt_script(
        script_path='/home/dlt/sharepoint/shrp_issue_type.py',
        target_table='raw_sharepoint.issue_type',
        fail_on_error=True,
