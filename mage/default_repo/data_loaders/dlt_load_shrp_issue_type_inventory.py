"""
Mage Data Loader: SharePoint Issue Type Inventory via DLT

Target: raw_sharepoint.issue_type_inventory
"""
...
@data_loader
def load_sp_issue_type_inventory_via_dlt(*args, **kwargs):
    """Load SharePoint Issue Type Inventory list via DLT."""
    ...
    result = run_dlt_script(
        script_path='/home/dlt/sharepoint/shrp_issue_type_inventory.py',
        target_table='raw_sharepoint.issue_type_inventory',
        fail_on_error=True,
