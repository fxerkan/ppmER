"""
Mage Data Loader: Jira Users via DLT

Target: raw_jira.users
"""
...
@data_loader
def load_jira_users_via_dlt(*args, **kwargs):
    """Load Jira users via DLT."""
    ...
    result = run_dlt_script(
        script_path='/home/dlt/jira/jira_users.py',
        target_table='raw_jira.users',
        fail_on_error=True,
