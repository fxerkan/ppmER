"""
Mage Data Loader: SharePoint Calculation Period via DLT

Target: raw_sharepoint.calculation_period
"""
...
@data_loader
def load_sp_calculation_period_via_dlt(*args, **kwargs):
    """Load SharePoint Calculation Period list via DLT."""
    ...
    result = run_dlt_script(
        script_path='/home/dlt/sharepoint/shrp_calculation_period.py',
        target_table='raw_sharepoint.calculation_period',
        fail_on_error=True,
