"""
Mage Data Loader: SharePoint Projects via DLT

Target: raw_sharepoint.projects
"""
...
@data_loader
def load_sp_projects_via_dlt(*args, **kwargs):
    """Load SharePoint Projects list via DLT."""
    ...
    result = run_dlt_script(
        script_path='/home/dlt/sharepoint/shrp_projects.py',
        target_table='raw_sharepoint.projects',
        fail_on_error=True,
