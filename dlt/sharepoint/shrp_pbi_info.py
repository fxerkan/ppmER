"""
SharePoint PBI Info DLT Pipeline

Extracts all items from the "PBI Info" SharePoint list and loads them to PostgreSQL.
...
# ===== CONFIGURATION =====
SHAREPOINT_LIST_TITLE = "PBI Info"
TABLE_NAME = "pbi_info"
SCHEMA_NAME = "raw_sharepoint"
PIPELINE_NAME = "shrp_pbi_info"


def create_pbi_info_resource(write_disposition: TWriteDisposition):
    ...
    def pbi_info_resource():
        """dlt resource for SharePoint PBI Info list."""
    ...
    return pbi_info_resource


def run_pipeline(mode: str = "initial"):
    """Run the SharePoint PBI Info pipeline."""
    print("=" * 80)
    print(f"SharePoint PBI Info Pipeline - Mode: {mode.upper()}")
    print("=" * 80)
    ...
    pbi_info_res = create_pbi_info_resource(write_disposition)
    data = pbi_info_res()
    ...
    print("\n" + "=" * 80)
    print("✅ SharePoint PBI Info Load Completed!")
    print("=" * 80)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SharePoint PBI Info DLT Pipeline")
