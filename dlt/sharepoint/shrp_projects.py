"""
SharePoint Projects DLT Pipeline

Extracts all items from the "Projects" SharePoint list and loads them to PostgreSQL.
...
# ===== CONFIGURATION =====
SHAREPOINT_LIST_TITLE = "Projects"
TABLE_NAME = "projects"
SCHEMA_NAME = "raw_sharepoint"
PIPELINE_NAME = "shrp_projects"


def create_projects_resource(write_disposition: TWriteDisposition):
    ...
    def projects_resource():
        """dlt resource for SharePoint Projects list."""
...
def run_pipeline(mode: str = "initial"):
    """Run the SharePoint Projects pipeline."""
    print("=" * 80)
    print(f"SharePoint Projects Pipeline - Mode: {mode.upper()}")
    print("=" * 80)
    ...
    projects_res = create_projects_resource(write_disposition)
    data = projects_res()
    ...
    print("\n" + "=" * 80)
    print("✅ SharePoint Projects Load Completed!")
    print("=" * 80)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SharePoint Projects DLT Pipeline")
