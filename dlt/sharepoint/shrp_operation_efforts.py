"""
SharePoint Operation Efforts DLT Pipeline

Extracts data from "operation_efforts.xlsx" Excel file stored in SharePoint Document Library
and loads it to PostgreSQL.

The Excel file contains operation efforts data that needs to be loaded into raw_sharepoint schema.
"""
...
SHAREPOINT_FILE_PATH = "/operation_efforts.xlsx"  # Path relative to the drive
SHEET_NAME = "operation_efforts"  # Sheet name in Excel file
TABLE_NAME = "operation_efforts"
SCHEMA_NAME = "raw_sharepoint"
PIPELINE_NAME = "shrp_operation_efforts"
...
def download_excel_file_from_sharepoint(site_id: str, drive_name: str, file_path: str, access_token: str) -> bytes:
    ...
    Args:
        ...
        file_path: Path to the file relative to the drive (e.g., "/operation_efforts.xlsx")
...
def create_operation_efforts_resource(write_disposition: TWriteDisposition):
    ...
    def operation_efforts_resource():
        """dlt resource for SharePoint operation efforts Excel file."""
    ...
    return operation_efforts_resource


def run_pipeline(mode: str = "initial"):
    """Run the SharePoint Operation Efforts pipeline."""
    print("=" * 80)
    print(f"SharePoint Operation Efforts Pipeline - Mode: {mode.upper()}")
    print("=" * 80)
    ...
    # Operation efforts data is always a complete snapshot, not incremental
    ...
    operation_efforts_res = create_operation_efforts_resource(write_disposition)
    data = operation_efforts_res()
    ...
    print("\n" + "=" * 80)
    print("✅ SharePoint Operation Efforts Load Completed!")
    print("=" * 80)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SharePoint Operation Efforts DLT Pipeline")
