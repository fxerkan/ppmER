"""
SharePoint Issue Type Inventory DLT Pipeline

Extracts all items from the "Issue Type Inventory" SharePoint list and loads them to PostgreSQL.
...
# ===== CONFIGURATION =====
SHAREPOINT_LIST_TITLE = "Issue Type Inventory"
TABLE_NAME = "issue_type_inventory"
SCHEMA_NAME = "raw_sharepoint"
PIPELINE_NAME = "shrp_issue_type_inventory"


def create_issue_type_inventory_resource(write_disposition: TWriteDisposition):
    ...
    def issue_type_inventory_resource():
        """dlt resource for SharePoint Issue Type Inventory list."""
    ...
    return issue_type_inventory_resource


def run_pipeline(mode: str = "initial"):
    """Run the SharePoint Issue Type Inventory pipeline."""
    print("=" * 80)
    print(f"SharePoint Issue Type Inventory Pipeline - Mode: {mode.upper()}")
    print("=" * 80)
    ...
    issue_type_inventory_res = create_issue_type_inventory_resource(write_disposition)
    data = issue_type_inventory_res()
    ...
    print("\n" + "=" * 80)
    print("✅ SharePoint Issue Type Inventory Load Completed!")
    print("=" * 80)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SharePoint Issue Type Inventory DLT Pipeline")
